...
public class ModalWindow extends Panel
{
	...
	{
		target.appendJavascript(getCloseJavacriptTopWindow());
	}
	...
	{
		return "settings.id = '" + getMarkupId() + "';\n" +
			"Wicket.Window.create(settings).show();\n";
	}

	private static String getCloseJavacriptTopWindow()
	{
		return "var close = function () { Wicket.Window.baseWindow.setTimeout(function() {\n"
			+ "  var wi = Wicket.Window.windowStack.length - 1;\n"
			+ "	 Wicket.Window.windowStack[wi].close();\n" + "	}, 0); }\n"
			+ "setTimeout(close, 0);";
	}
	...
	{
		return "var close = function () { Wicket.Window.baseWindow.setTimeout(function() {\n"
			+ "  Wicket.Window.windowMap['" + getMarkupId() + "'].close();\n" + " }, 0); }\n"
			+ "setTimeout(close, 0);";
	}
